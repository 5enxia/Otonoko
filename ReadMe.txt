================================================================================
MICROSOFT FOUNDATION CLASS ライブラリ: PQ_GRAPH プロジェクトの概要
===============================================================================

アプリケーション ウィザードが作成した PQ_GRAPH には Microsoft 
Foundation Class の基本的な使い方が示されています。アプリケーション作成のひな型
としてお使いください。

このファイルには PQ_GRAPH アプリケーションを構成している各ファイ
ルの概要説明が含まれます。
...
PQ_GRAPH.h
   ...
   CPQ_GRAPHApp アプリケーション クラスを宣言します。

PQ_GRAPH.cpp
   これは、アプリケーション クラス CPQ_GRAPHApp を含むメイン アプリケー
   ション ソース ファイルです。
...
res\PQ_GRAPH.ico
   ...
   アイコンはメイン リソース ファイル PQ_GRAPH.rc に含まれていま
   す。
...
PQ_GRAPHDlg.h, PQ_GRAPHDlg.cpp - ダイアログ
   これらのファイルは CPQ_GRAPHDlg クラスを含みます。このクラスはアプ
   リケーションのメイン ダイアログの動作を定義します。ダイアログ テンプレートは
   Microsoft Visual C++ で編集可能な PQ_GRAPH.rc に含まれます。
...
StdAfx.h, StdAfx.cpp
   ...
   PQ_GRAPH.pch や既にコンパイルされた型のファイル StdAfx.obj を
   ビルドするために使用されます。
